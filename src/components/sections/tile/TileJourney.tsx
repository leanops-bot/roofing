...
const STEPS = [
    {
        ...
        step_desc: "We inspect your tile roof for damage, leaks, and underlayment wear."
    },
    {
        step_title: "Transparent Quote",
        step_desc: "You receive a clear plan for replacement, repair, or restoration."
    },
    {
        step_title: "Scheduling & Preparation",
        step_desc: "We coordinate materials, permits, and timeline execution."
    },
    {
        step_title: "Expert Installation",
        step_desc: "Our crew installs tile roofing with precision fastening and sealing."
    },
    {
        step_title: "Walkthrough & Warranty",
        step_desc: "Final inspection, cleanup, and comprehensive warranty documentation."
    }
];

export const TileJourney = () => {
    return (
                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    >
                        ...
                        <p className="text-slate-600 text-lg font-medium leading-relaxed max-w-xl mx-auto">
                            A stress-free process built for clarity, quality, and long-term protection for your Sarasota home.
                        </p>
                    </motion.div>
                </div>
