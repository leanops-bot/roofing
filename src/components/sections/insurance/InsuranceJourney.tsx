...
import { Search, Calculator, Calendar, HardHat, ShieldCheck, CheckCircle2, ClipboardCheck, MessageSquare, Hammer, Ribbon } from "lucide-react";

export const InsuranceJourney = () => {
    const steps = [
        {
            title: "Assessment",
            desc: "Expert inspection and damage documentation.",
            icon: Search,
        },
        {
            title: "File Claim",
            desc: "Documentation assistance and support.",
            icon: ClipboardCheck,
        },
        {
            title: "Adjuster Meeting",
            desc: "On-site support during provider inspection.",
            icon: MessageSquare,
        },
        {
            title: "Elite Restoration",
            desc: "Professional roofing repair or replacement.",
            icon: Hammer,
        },
        {
            title: "Claim Closed",
            desc: "Final walkthrough and warranty activation.",
            icon: Ribbon,
        },
    ];
            ...
            <div className="container-custom px-4 md:px-0">
                ...
                <div className="text-center max-w-3xl mx-auto mb-20 leading-tight">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-[36px] md:text-[52px] font-black tracking-tight text-primary-navy uppercase italic mb-8">
                            Your Insurance <br />
                            <span className="text-primary-blue not-italic underline decoration-primary-gold-500/20">Restoration Journey</span>
                        </h2>
                        <p className="text-slate-600 text-lg font-medium leading-relaxed">
                            Apex Roofing provides a transparent, structured path from storm damage identification to elite project completion.
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="absolute top-[4.5rem] left-0 w-full h-px bg-slate-200 hidden lg:block" />
                        ...
                        {steps.map((step, idx) => (
                            ...
                            >
                                <div className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-sm hover:shadow-2xl hover:border-primary-gold-500/30 transition-all duration-300 text-center flex flex-col items-center h-full">
                                    ...
                                    <div className="mb-6">
                                        <span className="text-[10px] font-black text-primary-gold-500 uppercase tracking-[0.2em] mb-2 block italic leading-none">Step 0{idx + 1}</span>
                ...
                <div className="mt-20 p-10 rounded-[48px] bg-primary-navy shadow-2xl flex flex-col md:flex-row items-center justify-between gap-10">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h4 className="text-white font-black text-xl italic uppercase font-serif">Authority Advice</h4>
                            <p className="text-text-muted text-[10px] font-black uppercase tracking-widest leading-none mt-1 italic leading-relaxed">Dedicated claim documentation. No pressure quotes.</p>
                        </div>
                    </div>
