...
export const ShingleInstallationJourney = () => {
    const steps = [
        {
            title: "Free Roof Assessment",
            desc: "Drone measurements and professional inspection of your current roof health.",
            icon: Search,
        },
        {
            title: "Transparent Quote",
            desc: "Clear pricing with material upgrade options explained in detail.",
            icon: Calculator,
        },
        {
            title: "Preparation",
            desc: "Permits secured and quality shingle materials delivered on site.",
            icon: Calendar,
        },
        {
            title: "Expert Installation",
            desc: "Precision tear-off and install with storm-rated architectural systems.",
            icon: HardHat,
        },
        {
            title: "Final Certification",
            desc: "Detailed property cleanup and a final 50-point quality inspection.",
            icon: ShieldCheck,
        },
    ];
        ...
        <section className="py-24 bg-soft-beige overflow-hidden">
            <div className="container-custom">
                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    >
                        ...
                        <p className="text-slate-600 text-lg font-medium leading-relaxed">
                            Apex Roofing keeps the process clean, fast, and professional from initial inspection to final warranty activation.
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="absolute top-1/2 left-0 w-full h-px bg-slate-200 hidden lg:block" />
