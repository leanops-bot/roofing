                    ...
                    <div className="max-w-3xl">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-gold-500/10 border border-primary-gold-500/20 mb-8">
                                <Award className="w-4 h-4 text-primary-gold-500" />
                                <span className="text-primary-gold-500 text-[10px] font-black uppercase tracking-[0.2em]">Verified 5-Star Reputation</span>
                            </div>

                            <h1 className="text-[48px] md:text-[68px] lg:text-[84px] font-black tracking-tight leading-[0.95] text-white mb-8 italic uppercase">
                                <span className="text-primary-blue not-italic underline decoration-primary-gold-500/30 decoration-8 underline-offset-8">Reviews</span> <br />
                                <span className="text-white not-italic">& Testimonials</span>
                            </h1>

                            <p className="text-xl text-text-muted mb-10 leading-relaxed font-medium max-w-xl">
                                Real homeowners. Real results. See why Apex Roofing is trusted for premium roof replacement, repair, and storm restoration in {city}.
                            </p>

                            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-4 mb-12">
                                {[
                                    { text: "5-Star Experience", icon: Star },
                                    { text: "Verified Reviews", icon: ShieldCheck },
                                    { text: "Warranty-Backed Work", icon: Users },
                                ].map((item, idx) => (
                    ...
                    <div className="hidden lg:block">
                        ...
                        >
                            ...
                            <div className="absolute -right-12 -top-6 hidden xl:flex flex-col items-center justify-center w-32 h-32 bg-primary-gold-500 text-primary-navy rounded-full shadow-2xl z-20 font-black -rotate-6 border-4 border-white animate-pulse">
                                ...
                                <span className="text-[10px] tracking-[0.2em] leading-none mb-1">5-STAR</span>
                                <span className="text-2xl leading-none">RATED</span>
                            </div>
                        </motion.div>
                    </div>
                </div>
