                    ...
                    <div className="max-w-3xl">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-gold-500/10 border border-primary-gold-500/20 mb-8">
                                <Scale className="w-4 h-4 text-primary-gold-500" />
                                <span className="text-primary-gold-500 text-[10px] font-black uppercase tracking-[0.2em]">Transparent Honest Estimating</span>
                            </div>

                            <h1 className="text-[48px] md:text-[68px] lg:text-[84px] font-black tracking-tight leading-[0.95] text-white mb-8 italic uppercase">
                                <span className="text-primary-blue not-italic underline decoration-primary-gold-500/30 decoration-8 underline-offset-8">Roof</span> <br />
                                <span className="text-white not-italic">Pricing in {city}</span>
                            </h1>

                            <p className="text-xl text-text-muted mb-10 leading-relaxed font-medium max-w-xl">
                                Transparent price ranges for roof replacement and upgrades. Get clarity, not guesswork — with Apex Roofing.
                            </p>

                            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-4 mb-12">
                                {[
                                    { text: "No Hidden Fees", icon: ShieldCheck },
                                    { text: "Detailed Itemization", icon: Calculator },
                                    { text: "Material-Spec Pricing", icon: DollarSign },
                                    { text: "Fast Quote Turnaround", icon: Clock },
                                ].map((item, idx) => (
                    ...
                    <div className="hidden lg:block">
                        ...
                        >
                            ...
                            <div className="absolute -right-12 -top-6 hidden xl:flex flex-col items-center justify-center w-32 h-32 bg-primary-blue text-primary-navy rounded-full shadow-2xl z-20 font-black -rotate-6 border-4 border-white animate-pulse">
                                ...
                                <span className="text-[10px] tracking-[0.2em] leading-none mb-1">ACCURATE</span>
                                <span className="text-2xl leading-none">QUOTE</span>
                            </div>
                        </motion.div>
                    </div>
                </div>
