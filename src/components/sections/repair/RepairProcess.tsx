...
const STEPS = [
    {
        ...
        step_desc: "We assess the roof and locate the exact source of the issue."
    },
    {
        step_title: "Accurate Estimate",
        step_desc: "You receive a clear repair plan with transparent pricing."
    },
    {
        step_title: "Fast Scheduling",
        step_desc: "Repairs are scheduled quickly to prevent further damage."
    },
    {
        step_title: "Professional Repair",
        step_desc: "Our crew repairs leaks, flashing, and storm damage properly."
    },
    {
        step_title: "Walkthrough & Warranty",
        step_desc: "Final inspection and cleanup with warranty-backed workmanship."
    }
];
                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    >
                        ...
                        <p className="text-slate-600 text-lg font-medium leading-relaxed max-w-xl mx-auto">
                            Quick, reliable, professional — Apex Roofing makes roof repair simple for Florida homeowners.
                        </p>
                    </motion.div>
                </div>
