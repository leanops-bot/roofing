...
const STEPS = [
    {
        step_title: "Comprehensive Inspection",
        step_desc: "We inspect your commercial roof and identify risks and leaks."
    },
    {
        step_title: "Transparent Proposal",
        step_desc: "Clear pricing, materials, and comprehensive project timeline."
    },
    {
        step_title: "Scheduling & Planning",
        step_desc: "We coordinate permits, logistics, and material delivery."
    },
    {
        step_title: "Professional Installation",
        step_desc: "Experienced crews complete work with minimal business disruption."
    },
    {
        step_title: "Final Review & Warranty",
        step_desc: "Project walkthrough review with warranty documentation."
    }
];
                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    >
                        <h2 className="text-[36px] md:text-[52px] font-black tracking-tight leading-tight text-primary-navy mb-6 uppercase italic">
                            Our Commercial <br />
                            <span className="text-primary-blue not-italic underline decoration-primary-gold-500/20">Process</span>
                        </h2>
                        <p className="text-slate-600 text-lg font-medium leading-relaxed max-w-xl mx-auto">
                            A professional, repeatable process designed for commercial performance and predictable industrial scheduling.
                        </p>
                    </motion.div>
                </div>
