...
export const HeroCommercial = ({ city = "Sarasota" }: { city?: string }) => {
    return (
        <section className="relative min-h-screen flex items-center pt-32 pb-24 overflow-hidden bg-primary-navy">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    ...
                    alt="Commercial Roofing Florida"
                    ...
                    <div className="max-w-3xl">
                        ...
                        >
                            <nav className="flex items-center gap-2 mb-8">
                                ...
                                <span className="text-text-muted text-xs">/</span>
                                <span className="text-primary-blue text-xs font-black uppercase tracking-widest">Commercial Roofing</span>
                            </nav>

                            <h1 className="text-[48px] md:text-[68px] lg:text-[84px] font-black tracking-tight leading-[0.95] text-white mb-8 italic uppercase">
                                <span className="text-primary-blue not-italic underline decoration-primary-gold-500/30 decoration-8 underline-offset-8">Commercial</span> <br />
                            ...
                            <p className="text-xl text-text-muted mb-10 leading-relaxed font-medium max-w-xl">
                                Flat roof systems, coatings, repairs, and long-term maintenance — built to protect your assets, reduce downtime, and extend roof lifespan.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-6 mb-12">
                                {[
                                    ...
                                    { text: "Maintenance Plans", icon: Shield },
                                ].map((item, idx) => (
                    ...
                    <div className="hidden lg:block">
                        ...
                        >
                            ...
                            <div className="absolute -right-12 -top-6 hidden xl:flex flex-col items-center justify-center w-32 h-32 bg-primary-gold-500 text-primary-navy rounded-full shadow-2xl z-20 font-black -rotate-6 border-4 border-white animate-bounce">
                                ...
                                <span className="text-2xl leading-none">COMMERCIAL</span>
                            </div>
                        </motion.div>
                    </div>
                </div>
