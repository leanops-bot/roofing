                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="max-w-3xl">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-gold-500/10 border border-primary-gold-500/20 mb-8">
                                <BadgeDollarSign className="w-4 h-4 text-primary-gold-500" />
                                <span className="text-primary-gold-500 text-[10px] font-black uppercase tracking-[0.2em]">Flexible Payment Plans Available</span>
                            </div>
                            ...
                            <h1 className="text-[48px] md:text-[68px] lg:text-[84px] font-black tracking-tight leading-[0.95] text-white mb-8 italic uppercase">
                                ...
                                <span className="text-white not-italic">Financing in {city}</span>
                            </h1>

                            <p className="text-xl text-text-muted mb-10 leading-relaxed font-medium max-w-xl">
                                Upgrade your roof today with flexible financing options designed for Florida homeowners. Affordable monthly payments. Fast approvals. Zero stress.
                            </p>

                            <div className="flex flex-wrap gap-6 mb-12">
                                {[
                                    { text: "Fast Approval", icon: Clock },
                                    { text: "No Hidden Fees", icon: Shield },
                                    { text: "Licensed & Insured", icon: CheckCircle },
                                    { text: "Monthly Plans", icon: Wallet },
                                ].map((item, idx) => (
                    ...
                    <div className="hidden lg:block">
                        ...
                        >
                            ...
                            {/* Pro Badge */}
                            <div className="absolute -right-12 -top-6 hidden xl:flex flex-col items-center justify-center w-32 h-32 bg-primary-blue text-primary-navy rounded-full shadow-2xl z-20 font-black rotate-12 border-4 border-white">
                                <Shield className="w-8 h-8 mb-1" />
                                <span className="text-[10px] tracking-[0.2em] leading-none mb-1">PREMIUM</span>
                                <span className="text-2xl leading-none">TRUST</span>
                            </div>
                        </motion.div>
                    </div>
                </div>
