...
export const HeroReplacement = ({ city = "Sarasota" }: { city?: string }) => {
    return (
        <section className="relative min-h-screen flex items-center pt-32 pb-24 overflow-hidden bg-primary-navy">
            {/* Cinematic Background Image */}
            <div className="absolute inset-0 z-0">
                <img
                    src="https://images.unsplash.com/photo-1632759929849-c16773537a67?q=80&w=2000&auto=format&fit=crop"
                    alt="Florida Roofing"
                    ...
                    <div className="max-w-3xl">
                        ...
                        >
                            <nav className="flex items-center gap-2 mb-8">
                                ...
                                <span className="text-text-muted text-xs">/</span>
                                <span className="text-primary-blue text-xs font-black uppercase tracking-widest">Roof Replacement</span>
                            </nav>

                            <h1 className="text-[48px] md:text-[68px] lg:text-[84px] font-black tracking-tight leading-[0.95] text-white mb-8 italic uppercase">
                                Roof <span className="text-primary-blue not-italic underline decoration-primary-gold-500/30 decoration-8 underline-offset-8">Replacement</span> <br />
                            ...
                            <p className="text-xl text-text-muted mb-10 leading-relaxed font-medium max-w-xl">
                                Upgrade your home with hurricane-ready materials, expert installation, and warranty-backed craftsmanship from Apex Roofing.
                            </p>
                    ...
                    <div className="hidden lg:block">
                        ...
                        >
                            ...
                            <div className="absolute -right-12 -top-6 hidden xl:flex flex-col items-center justify-center w-32 h-32 bg-primary-gold-500 text-primary-navy rounded-full shadow-2xl z-20 font-black rotate-6 border-4 border-white animate-pulse">
                                <span className="text-[10px] tracking-[0.2em] leading-none mb-1">APPROVED</span>
                                <span className="text-2xl leading-none">FLORIDA</span>
                                <span className="text-[10px] tracking-[0.2em] leading-none mt-1">CERTIFIED</span>
                            </div>
                        </motion.div>
                    </div>
                </div>
